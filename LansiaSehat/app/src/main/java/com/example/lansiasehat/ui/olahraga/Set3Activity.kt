...
class Set3Activity : AppCompatActivity(), OlahragaAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val typedArray = resources.obtainTypedArray(R.array.gambarset3_array)
        val gambarSet3 = IntArray(typedArray.length()) { i ->
            typedArray.getResourceId(i, -1)
        }
        typedArray.recycle()

        val adapter = OlahragaAdapter(this, gambarSet3, this)
        ...
        if (position in videoPaths.indices) {
            ...
            videoPaths.forEachIndexed { index, path ->
                ...
                videoRef.downloadUrl.addOnSuccessListener { uri ->
                    ...
                    Log.e("Set3Activity", "Error getting video URL", exception)
                    latch.countDown()
                }
            }
            ...
            Thread {
                ...
                runOnUiThread {
                    val intent = Intent(this, DetailActivity::class.java).apply {
                        ...
                        putExtra("SOURCE", "Set3Activity")
                    }
                    startActivity(intent)
                }
            }.start()
        } else {
            Log.e("Set3Activity", "Invalid position: $position")
        }
    }
}